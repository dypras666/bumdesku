                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                {{-- Net Cash Flow --}}
                                @php $netCashFlow = $reportData['net_cash_flow'] ?? ($netOperatingCashFlow + $netInvestingCashFlow + $netFinancingCashFlow); @endphp
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0">
                                                Perubahan kas bersih: {{ format_currency($reportData['net_cash_flow'] ?? 0) }}
                                                @if(($reportData['beginning_cash'] ?? 0) > 0)
                                                    ({{ number_format((($reportData['net_cash_flow'] ?? 0) / ($reportData['beginning_cash'] ?? 1)) * 100, 1) }}% dari kas awal)
                                                @endif
                                            </p>
                                            ...
                                            <p>{{ ($reportData['net_cash_flow'] ?? 0) > 0 ? 'Meningkat' : 'Menurun' }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <h5>Status Likuiditas</h5>
                                            <p class="mb-0">
                                                @if(($reportData['net_cash_flow'] ?? 0) > 0)
                                                    <span class="badge badge-success">Positif</span> - Kas mengalami peningkatan
                                                @elseif(($reportData['net_cash_flow'] ?? 0) < 0)
