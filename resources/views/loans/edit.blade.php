...
@section('title', 'Edit Pinjaman Modal')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1>Edit Pinjaman Modal</h1>
        </div>
        <div class="col-sm-6">
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Form Edit Pinjaman Modal</h3>
            <div class="card-tools">
                <span class="badge badge-info">{{ $loan->loan_code }}</span>
            </div>
        </div>
        <form action="{{ route('loans.update', $loan->id) }}" method="POST">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('borrower_name') is-invalid @enderror" 
                                   id="borrower_name" name="borrower_name" 
                                   value="{{ old('borrower_name', $loan->borrower_name) }}" required>
                            @error('borrower_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('borrower_phone') is-invalid @enderror" 
                                   id="borrower_phone" name="borrower_phone" 
                                   value="{{ old('borrower_phone', $loan->borrower_phone) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('borrower_address') is-invalid @enderror" 
                                      id="borrower_address" name="borrower_address" rows="3">{{ old('borrower_address', $loan->borrower_address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('borrower_id_number') is-invalid @enderror" 
                                   id="borrower_id_number" name="borrower_id_number" 
                                   value="{{ old('borrower_id_number', $loan->borrower_id_number) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('loan_type') is-invalid @enderror" 
                                ...
                                <option value="bunga" {{ old('loan_type', $loan->loan_type) == 'bunga' ? 'selected' : '' }}>Pinjaman dengan Bunga</option>
                                <option value="bagi_hasil" {{ old('loan_type', $loan->loan_type) == 'bagi_hasil' ? 'selected' : '' }}>Pinjaman Bagi Hasil</option>
                                <option value="tanpa_bunga" {{ old('loan_type', $loan->loan_type) == 'tanpa_bunga' ? 'selected' : '' }}>Pinjaman Tanpa Bunga</option>
                            </select>
                            @error('loan_type')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group" id="profit_sharing_group" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('profit_sharing_percentage') is-invalid @enderror" 
                                       ...
                                       value="{{ old('profit_sharing_percentage', $loan->profit_sharing_percentage) }}" 
                                       min="0" max="100" step="0.1">
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
                        ...
                        <div class="form-group" id="expected_profit_group" style="display: none;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('expected_profit') is-invalid @enderror" 
                                       id="expected_profit" name="expected_profit" 
                                       value="{{ old('expected_profit', $loan->expected_profit) }}" 
                                       min="0" step="50000">
                            </div>
                        ...
                        <div class="form-group" id="business_description_group" style="display: none;">
                            ...
                            <textarea class="form-control @error('business_description') is-invalid @enderror" 
                                      ...
                                      placeholder="Jelaskan usaha yang akan dijalankan dengan dana pinjaman ini...">{{ old('business_description', $loan->business_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('admin_fee') is-invalid @enderror" 
                                       ...
                                       value="{{ old('admin_fee', $loan->admin_fee) }}" 
                                       min="0" step="5000">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('loan_term_months') is-invalid @enderror" 
                                ...
                                <option value="6" {{ old('loan_term_months', $loan->loan_term_months) == 6 ? 'selected' : '' }}>6 Bulan</option>
                                <option value="12" {{ old('loan_term_months', $loan->loan_term_months) == 12 ? 'selected' : '' }}>12 Bulan</option>
                                <option value="18" {{ old('loan_term_months', $loan->loan_term_months) == 18 ? 'selected' : '' }}>18 Bulan</option>
                                <option value="24" {{ old('loan_term_months', $loan->loan_term_months) == 24 ? 'selected' : '' }}>24 Bulan</option>
                                <option value="36" {{ old('loan_term_months', $loan->loan_term_months) == 36 ? 'selected' : '' }}>36 Bulan</option>
                                <option value="48" {{ old('loan_term_months', $loan->loan_term_months) == 48 ? 'selected' : '' }}>48 Bulan</option>
                                <option value="60" {{ old('loan_term_months', $loan->loan_term_months) == 60 ? 'selected' : '' }}>60 Bulan</option>
                            </select>
                            ...
                            <select class="form-control @error('account_id') is-invalid @enderror" 
                                ...
                                @foreach($accounts as $account)
                                    <option value="{{ $account->id }}" 
                                            {{ old('account_id', $loan->account_id) == $account->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Catatan tambahan tentang pinjaman ini...">{{ old('notes', $loan->notes) }}</textarea>
                            @error('notes')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div id="monthly_payment_display" class="text-primary h5">{{ $loan->formatted_monthly_payment }}</div>
                                    </div>
                                    <div class="col-md-4">
                ...
                @if($loan->status != 'pending')
                    <div class="alert alert-warning">
                        ...
                        <strong>Perhatian:</strong> Pinjaman ini sudah disetujui. Perubahan data akan mempengaruhi perhitungan yang sudah ada.
                    </div>
                @endif
            </div>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Update Pinjaman
                </button>
...
@section('js')
    <script>
        $(document).ready(function() {
            // Function to show/hide fields based on loan type
            function toggleLoanTypeFields() {
                ...
                // Recalculate payment when loan type changes
                calculatePayment();
            }
            ...
            function calculatePayment() {
                ...
                if (loanAmount > 0 && loanTermMonths > 0 && loanType) {
                    ...
                    let totalPayment = 0;
                    let totalInterestOrProfit = 0;
                    let labelText = 'Total Bunga';
                    ...
                    if (loanType === 'bunga') {
                        ...
                        if (interestRate > 0) {
                            ...
                            totalInterestOrProfit = totalPayment - loanAmount;
                        } else {
                            monthlyPayment = loanAmount / loanTermMonths;
                            totalPayment = loanAmount;
                            totalInterestOrProfit = 0;
                        }
                        ...
                        const profitShare = expectedProfit * (profitSharingPercentage / 100);
                        const totalAmount = loanAmount + profitShare;
                        monthlyPayment = totalAmount / loanTermMonths;
                        totalPayment = totalAmount;
                        totalInterestOrProfit = profitShare;
                        labelText = 'Total Bagi Hasil';
                    ...
                    // Add admin fee to total payment
                    ...
                    $('#total_interest_display').text('Rp ' + numberFormat(totalInterestOrProfit));
                    
                    // Update label for the third column
                    $('#total_interest_display').prev().text(labelText + ':');
            ...
            // Bind loan type change
            $('#loan_type').on('change', toggleLoanTypeFields);
